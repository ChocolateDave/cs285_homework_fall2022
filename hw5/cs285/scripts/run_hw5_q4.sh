...
do
    python cs285/scripts/run_hw5_awac.py --env_name PointmassEasy-v0 --exp_name q4_awac_easy_unsupervised_lam${LAMBDA} --use_rnd --num_exploration_steps=20000 --unsupervised_exploration --awac_lambda $LAMBDA -gpu_id 0 &
    python cs285/scripts/run_hw5_awac.py --env_name PointmassEasy-v0 --use_rnd --num_exploration_steps=20000 --awac_lambda $LAMBDA --exp_name q4_awac_easy_supervised_lam${LAMBDA} -gpu_id 0 &
