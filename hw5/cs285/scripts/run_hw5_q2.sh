...
do
    python cs285/scripts/run_hw5_expl.py --env_name PointmassMedium-v0 --use_rnd --num_exploration_steps=$STEP --offline_exploitation --cql_alpha=0.0 --unsupervised_exploration --exp_name q2_dqn_numsteps_[${STEP}] --exploit_rew_shift 1 --exploit_rew_scale -gpu_id $1 100 &
    python cs285/scripts/run_hw5_expl.py --env_name PointmassMedium-v0 --use_rnd --num_exploration_steps=$STEP --offline_exploitation --cql_alpha=0.1 --unsupervised_exploration --exp_name q2_cql_numsteps_[${STEP}] --exploit_rew_shift 1 --exploit_rew_scale 100 -gpu_id $1 &
done
wait
echo "SP2 done!";
...
do
python cs285/scripts/run_hw5_expl.py --env_name PointmassMedium-v0 --use_rnd --unsupervised_exploration --offline_exploitation --cql_alpha=$ALPHA --exp_name q2_alpha[${ALPHA}] --exploit_rew_shift 1 --exploit_rew_scale 100 -gpu_id $1 &
done
wait
echo "SP3 done!";
echo "All done!"